namespace Csharp_Student_System
{
	partial class PrintJUNIOR
	{
		...
		private void InitializeComponent()
		{
			...
			this.pictureBoxBarcode.Location = new System.Drawing.Point(756, 10);
			...
			this.label1.Text = "JUNIOR HIGH VARIABLE";
			// 
			// pictureBox1
			// 
			...
			this.pictureBoxStudentImage.Location = new System.Drawing.Point(688, 10);
			...
			this.Name = "PrintJUNIOR";
			this.Text = "PrintJUNIOR";
			this.Load += new System.EventHandler(this.PrintJUNIOR_Load);
