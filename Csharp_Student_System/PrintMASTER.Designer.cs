namespace Csharp_Student_System
{
	partial class PrintMASTER
	{
		...
		private void InitializeComponent()
		{
			...
			this.pictureBoxBarcode.Location = new System.Drawing.Point(744, 13);
			...
			this.pictureBoxBarcode.TabIndex = 6;
			...
			this.label1.Text = "MASTER VARIABLE";
			// 
			// pictureBox1
			// 
			...
			this.pictureBoxStudentImage.Location = new System.Drawing.Point(675, 13);
			...
			this.Name = "PrintMASTER";
			this.Text = "PrintMASTER";
			this.Load += new System.EventHandler(this.PrintMASTER_Load);
