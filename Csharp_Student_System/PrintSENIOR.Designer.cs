namespace Csharp_Student_System
{
	partial class PrintSENIOR
	{
		...
		private void InitializeComponent()
		{
			...
			this.pictureBoxBarcode.Location = new System.Drawing.Point(743, 10);
			...
			this.label1.Text = "SENIOR HIGH VARIABLE";
			// 
			// pictureBox1
			// 
			...
			this.pictureBoxStudentImage.Location = new System.Drawing.Point(693, 10);
			...
			this.Name = "PrintSENIOR";
			this.Text = "PrintSENIOR";
			this.Load += new System.EventHandler(this.PrintSENIOR_Load);
