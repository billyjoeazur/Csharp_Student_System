namespace Csharp_Student_System
{
	partial class ManageEMPLOYEE
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBoxSSS = new Bunifu.Framework.UI.BunifuMetroTextbox();
			...
			this.textBoxContactNumber = new Bunifu.Framework.UI.BunifuMetroTextbox();
			...
			this.textBoxDesignation = new Bunifu.Framework.UI.BunifuMetroTextbox();
			...
			this.panelHeader.Controls.Add(this.pictureBoxQRcode);
			...
			this.tableLayoutPanelWithSearchBar.TabIndex = 6;
			// 
			// SearchBox
			// 
			...
			this.tableLayoutMain.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.tableLayoutMain.Location = new System.Drawing.Point(0, 366);
			this.tableLayoutMain.Margin = new System.Windows.Forms.Padding(4);
			this.tableLayoutMain.Name = "tableLayoutMain";
			this.tableLayoutMain.RowCount = 1;
			this.tableLayoutMain.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 100F));
			this.tableLayoutMain.Size = new System.Drawing.Size(814, 132);
			...
			this.tableLayout4Cells.Location = new System.Drawing.Point(681, 4);
			...
			this.tableLayout4Cells.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this.tableLayout4Cells.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this.tableLayout4Cells.Size = new System.Drawing.Size(129, 124);
			...
			this.buttonAddStudent.Size = new System.Drawing.Size(121, 23);
			...
			this.tableLayout2Cells.Location = new System.Drawing.Point(546, 4);
			...
			this.tableLayout1Cell.Controls.Add(this.textBoxPHIL, 0, 2);
			this.tableLayout1Cell.Controls.Add(this.textBoxTIN, 0, 0);
			this.tableLayout1Cell.Controls.Add(this.textBoxSSS, 0, 1);
			this.tableLayout1Cell.Dock = System.Windows.Forms.DockStyle.Fill;
			this.tableLayout1Cell.Location = new System.Drawing.Point(411, 4);
			this.tableLayout1Cell.Margin = new System.Windows.Forms.Padding(4);
			this.tableLayout1Cell.Name = "tableLayout1Cell";
			this.tableLayout1Cell.RowCount = 3;
			this.tableLayout1Cell.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
			this.tableLayout1Cell.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
			this.tableLayout1Cell.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
			this.tableLayout1Cell.Size = new System.Drawing.Size(127, 124);
			...
			this.textBoxPHIL.MaximumSize = new System.Drawing.Size(267, 142);
			this.textBoxPHIL.Name = "textBoxPHIL";
			this.textBoxPHIL.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.textBoxPHIL.Size = new System.Drawing.Size(117, 32);
			this.textBoxPHIL.TabIndex = 79;
			this.textBoxPHIL.Text = "PHIL";
			this.textBoxPHIL.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.textBoxPHIL.Enter += new System.EventHandler(this.textBoxPHIL_Enter);
			this.textBoxPHIL.Leave += new System.EventHandler(this.textBoxPHIL_Leave);
			// 
			// textBoxTIN
			// 
			...
			this.textBoxTIN.MaximumSize = new System.Drawing.Size(267, 142);
			this.textBoxTIN.Name = "textBoxTIN";
			this.textBoxTIN.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.textBoxTIN.Size = new System.Drawing.Size(117, 31);
			this.textBoxTIN.TabIndex = 77;
			this.textBoxTIN.Text = "TIN";
			this.textBoxTIN.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.textBoxTIN.Enter += new System.EventHandler(this.textBoxTIN_Enter);
			this.textBoxTIN.Leave += new System.EventHandler(this.textBoxTIN_Leave);
			// 
			// textBoxSSS
			// 
			...
			this.textBoxSSS.MaximumSize = new System.Drawing.Size(267, 142);
			this.textBoxSSS.Name = "textBoxSSS";
			this.textBoxSSS.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.textBoxSSS.Size = new System.Drawing.Size(117, 31);
			this.textBoxSSS.TabIndex = 78;
			this.textBoxSSS.Text = "SSS";
			this.textBoxSSS.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.textBoxSSS.Enter += new System.EventHandler(this.textBoxSSS_Enter);
			this.textBoxSSS.Leave += new System.EventHandler(this.textBoxSSS_Leave);
			// 
			// tableLayout6Cells
			// 
			...
			this.tableLayout6Cells.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
			this.tableLayout6Cells.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
			this.tableLayout6Cells.Controls.Add(this.bdate, 2, 2);
			this.tableLayout6Cells.Controls.Add(this.textBoxAddress, 2, 1);
			this.tableLayout6Cells.Controls.Add(this.textBoxContactNumber, 2, 0);
			...
			this.tableLayout6Cells.Controls.Add(this.textBoxDesignation, 1, 1);
			this.tableLayout6Cells.Controls.Add(this.textBoxContactPerson, 1, 2);
			...
			this.tableLayout6Cells.Size = new System.Drawing.Size(399, 124);
			...
			this.bdate.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.bdate.Location = new System.Drawing.Point(269, 85);
			this.bdate.Name = "bdate";
			this.bdate.Size = new System.Drawing.Size(127, 36);
			this.bdate.TabIndex = 77;
			this.bdate.Value = new System.DateTime(2020, 8, 16, 9, 1, 17, 765);
			// 
			// textBoxAddress
			// 
			...
			this.textBoxContactNumber.MaximumSize = new System.Drawing.Size(267, 142);
			this.textBoxContactNumber.Name = "textBoxContactNumber";
			this.textBoxContactNumber.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.textBoxContactNumber.Size = new System.Drawing.Size(123, 31);
			this.textBoxContactNumber.TabIndex = 73;
			this.textBoxContactNumber.Text = "Contact Number";
			this.textBoxContactNumber.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			...
			this.textBoxFname.Size = new System.Drawing.Size(123, 31);
			...
			this.textBoxMname.Size = new System.Drawing.Size(123, 32);
			...
			this.textBoxLname.Size = new System.Drawing.Size(123, 31);
			...
			this.tableLayoutPanel1.Size = new System.Drawing.Size(127, 35);
			...
			this.textBoxIDno.Size = new System.Drawing.Size(53, 25);
			...
			this.textBoxDesignation.MaximumSize = new System.Drawing.Size(267, 38);
			...
			this.textBoxDesignation.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			...
			this.textBoxContactPerson.MaximumSize = new System.Drawing.Size(267, 38);
			this.textBoxContactPerson.Name = "textBoxContactPerson";
			this.textBoxContactPerson.Size = new System.Drawing.Size(123, 32);
			this.textBoxContactPerson.TabIndex = 72;
			this.textBoxContactPerson.Text = "Contact Person";
			this.textBoxContactPerson.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.textBoxContactPerson.Enter += new System.EventHandler(this.textBoxContactPerson_Enter);
			this.textBoxContactPerson.Leave += new System.EventHandler(this.textBoxContactPerson_Leave);
			// 
			...
			this.tableLayoutPanelWithDatagGridView.Size = new System.Drawing.Size(814, 271);
			this.tableLayoutPanelWithDatagGridView.TabIndex = 8;
			// 
			// dataGridView1
			// 
			...
			this.dataGridView1.Size = new System.Drawing.Size(806, 263);
		...
		private Bunifu.Framework.UI.BunifuMetroTextbox textBoxContactNumber;
		private System.Windows.Forms.TableLayoutPanel tableLayout6Cells;
		private Bunifu.Framework.UI.BunifuMetroTextbox textBoxContactPerson;
		...
		private Bunifu.Framework.UI.BunifuMetroTextbox textBoxDesignation;
		...
		private Bunifu.Framework.UI.BunifuMetroTextbox textBoxPHIL;
		private Bunifu.Framework.UI.BunifuMetroTextbox textBoxTIN;
		private Bunifu.Framework.UI.BunifuMetroTextbox textBoxSSS;
		private Bunifu.Framework.UI.BunifuDatepicker bdate;
		public Bunifu.Framework.UI.BunifuMetroTextbox textBoxIDno;
	}
}