namespace Csharp_Student_System
{
	partial class PrintCOLLEGE
	{
		...
		private void InitializeComponent()
		{
			...
			this.pictureBoxBarcode.Location = new System.Drawing.Point(759, 13);
			...
			this.label1.Text = "COLLEGE VARIABLE";
			// 
			// pictureBox1
			// 
			...
			this.pictureBoxStudentImage.Location = new System.Drawing.Point(691, 13);
			...
			this.Name = "PrintCOLLEGE";
			this.Text = "PrintCOLLEGE";
			this.Load += new System.EventHandler(this.PrintCOLLEGE_Load);
